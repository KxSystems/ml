...
dl:{[s;url]$[s;;`/:]0N!system"curl ",(getenv[`GH_APIREAD]," -s -L ",url,$[s;" -J -O";""])}
download:{
 assets:.j.k[0N!dl[0b]"https://api.github.com/repos/KxSystems/embedPy/releases/",$[not[count x]|x~"latest";"latest";"tags/",x]]`assets;
...
getembedpy:{@[x;y;{-2"ERROR: ",x;exit 1}]}{install extract 0N!download x}
//
