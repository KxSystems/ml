...
download:{
 assets:.j.k[dl[0b]"https://api.github.com/repos/KxSystems/embedPy/releases/",$[not[count 0N!x]|0N!x~"latest";"latest";"tags/",x]]`assets;
...
getembedpy:{@[x;y;{-2"ERROR: ",x;exit 1}]}{install extract download 0N!x}
//
