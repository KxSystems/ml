...
// @param isAbs {bool} Whether absolute values should be considered
...
// @return {dict} FFT coefficient given real inputs and extracting real, 
...
// @param data {num[]} Numerical data points
// @return {bool} Series contains any duplicate values
...
// @param data {num[]} Numerical data points
// @return {bool} Does data contain a duplicate of the maximum value
...
// @param data {num[]} Numerical data points
// @return {bool} Does data contain a duplicate of the minimum value
...
// @return {bool} Is standard deviation larger than ratio times max-min
...
// @param data {num[]} Numerical data points
// @return {num} Maximum value of the series
fresh.feat.max:{[data]
  max data
  }
...
// @param data {num[]} Numerical data points
// @return {num} Mean value of the series
...
// @param data {num[]} Numerical data points
// @return {num} Median value of the series
fresh.feat.med:{[data]
  med data
  }
...
// @param data {num[]} Numerical data points
// @return {num} Minimum value of the series
fresh.feat.min:{[data]
  min data
  }
...
// @param data {num[]} Numerical data points
// @param crossVal {num} Crossing va;ue
...
// @param data {num[]} Numerical data points
// @param minVal {num} Min value allowed
// @param maxVal {num} Max value allowed
...
// @param data {num[]} Numerical data points
// @return {num} Sum of all points present more than once
...
// @param data {num[]} Numerical data points
// @return {num} Sum of all values present more than once
...
// @param data {num[]} Numerical data points
// @return {num} Sum of values within the series
...
// @return {bool} Measure of symmetry 
