...
all(cols[result] ~`likeEmail`likeURL`likeNumber`isStop`tokens`lemmas`uniPOS`pennPOS`starts;result[`likeEmail] ~enlist 000010000000000000b;result[`likeURL]~enlist 000000000000000101b;result[`likeNumber]~enlist 000000010000000000b;result[`isStop]~enlist 000101010101001011b;result[`tokens]~enlist `email`jeff`bezos`at,(`$"jeff@amazon.com"),`he`gets,(`$"65,536"),`emails`a`day`from`people`asking`about`www.blueorigin.com`or`https://amazon.ca;result[`lemmas]~ enlist `email`jeff`bezos`at,(`$"jeff@amazon.com"),(`$"-PRON-"),`get,(`$"65,536"),`email`a`day`from`people`ask`about`www.blueorigin.com`or`https://amazon.ca;result[`uniPOS]~ enlist `NOUN`PROPN`PROPN`ADP`X`PRON`VERB`NUM`NOUN`DET`NOUN`ADP`NOUN`VERB`ADP`X`CCONJ`PRON;result[`pennPOS] ~ enlist `NN`NNP`NNP`IN`ADD`PRP`VBZ`CD`NNS`DT`NN`IN`NNS`VBG`IN`ADD`CC`PRP;result[`starts]~enlist 0 6 11 17 20 37 40 45 52 59 61 65 70 77 84 90 109 112)
