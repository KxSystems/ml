...
truncate[2; avgMSE]~ .63 .76 .78 .79 .75
minMSE:min each mseTest[corpus] each clusterlist
truncate[2;minMSE]~ .13 .28 .28 .28 .3


/testing bisecting kmeans
...
(enlist 0 1 3 4) ~ cluster.fastRadix[5#corpus; 10]
...
(enlist 0 1 3 4 5)~cluster.radix[6#corpus;10]
...
.07 ~ truncate[2] cluster.MSE corpus[1 3 5 7 9; `keywords]

/testing cluster.i.groupByCentroids
...
cluster.i.groupByCentroids[centroids 1 2; corpus `keywords]~ (0 9 10 11 12;1 2 7 8 13 14;3 4 5 6)
...
(0 7 _ til 100) ~ .nlp.cluster.summarize[corpus; 1]
